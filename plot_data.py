...
plot(data1['Date'], data1['Occupied'], ["Fastned 2x 4 CCS Plugs 350kW (Lenzburg + Suhr)"], "Occupied Chargers Fastned", 96)
plot(data2['Date'], data2['Occupied'], ["EvPass Network Switzerland"], "Occupied Chargers EvPass", 96)
plot(data3['Date'], data3['Occupied'], ["Plug N Roll Network Switzerland"], "Occupied Chargers Plug n Roll", 96)
plot(data4['Date'], data4['Occupied'], ["eCarUp Network Switzerland (public)"], "Occupied Chargers eCarUp", 96)
plot(data5['Date'], data5['Occupied'], ["Swisscharge"], "Occupied Chargers Swisscharge", 96)
multiplot(data1['Date'], data1['Occupied'],  data2['Occupied'],  data3['Occupied'], data4['Occupied'],  data5['Occupied'], ["Fastned", "EvPass", "PlugNroll", "EcarUp", "Swisscharge"], "Occupied chargers", 96)
...
multiplot(data1['Date'], useage[0],  useage[1], useage[2], useage[3], useage[4], labels, "Charge net useage workload [%]", 96)
...
multiplot(data1['Date'], normalized_session1, normalized_session2, normalized_session3, normalized_session4, normalized_session5, labels, "Cumulated charge sessions divided by number of plugs of charge network", 96)
...
multiplot(data1['Date'], calculate_totalconnectors(data1), calculate_totalconnectors(data2), calculate_totalconnectors(data3), calculate_totalconnectors(data4), calculate_totalconnectors(data5), ["Fastned", "EvPass", "PlugNroll", "EcarUp", "Swisscharge"], "Total chargers", 96)
#Plot number of total chargers per network
multiplot(data1['Date'], data1['Unknown'], data2['Unknown'], data3['Unknown'], data4['Unknown'], data5['Unknown'], ["Fastned", "EvPass", "PlugNroll", "EcarUp", "Swisscharge"], "Status uknnown", 96)
#Plot number of total chargers per network
multiplot(data1['Date'], data1['Outofservice'], data2['Outofservice'], data3['Outofservice'], data4['Outofservice'], data5['Outofservice'], ["Fastned", "EvPass", "PlugNroll", "EcarUp", "Swisscharge"], "Status Out of order", 96)